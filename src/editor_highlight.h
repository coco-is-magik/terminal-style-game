...
#define EDITOR_FLOOR_HIGHLIGHT_SELECTED_GLYPH ((uint8_t)'F')
#define EDITOR_FLOOR_HIGHLIGHT_HOVER_GLYPH ((uint8_t)'f')
#define EDITOR_CEILING_HIGHLIGHT_SELECTED_GLYPH ((uint8_t)'C')
#define EDITOR_CEILING_HIGHLIGHT_HOVER_GLYPH ((uint8_t)'c')
