...
> Archived historical roadmap. Current roadmap authority is
> [`../../FEATURE_ROADMAP.md`](../../FEATURE_ROADMAP.md). This document preserves
> the pre-archive long-form R0-R12 roadmap text; some internal references reflect
> its original top-level `docs/` location.
...
**Status:** Verified — Increments I1 and I2 complete and verified
...
Increment I1 implementation and verification are recorded in
[`R6_INCREMENT_I1_IMPLEMENTATION_RECORD_2026-08-13.md`](R6_INCREMENT_I1_IMPLEMENTATION_RECORD_2026-08-13.md);
increment I2 is recorded in
[`R6_INCREMENT_I2_IMPLEMENTATION_RECORD_2026-08-13.md`](R6_INCREMENT_I2_IMPLEMENTATION_RECORD_2026-08-13.md).
R7 is next.
...
`reviews/2026-09-11-roadmap-r12-closeout.md`. I1 decision/implementation record:
