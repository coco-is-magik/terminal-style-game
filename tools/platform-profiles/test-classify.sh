...
printf '%s\n' 'Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?' >"$tmp/docker-daemon.log"
...
check 3 'FAIL-TOOL|docker-daemon-or-runtime|1' docker 1 "$tmp/docker-daemon.log"
