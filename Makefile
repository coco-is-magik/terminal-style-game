...
$(TEST_UI_DOCUMENT_RUNNER): tests/test_ui_document.c $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_document.c $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) \
		$(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
		-o $(TEST_UI_DOCUMENT_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_LAYOUT_RESOLVER_RUNNER): tests/test_ui_layout_resolver.c $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
...
$(TEST_UI_RENDER_ADAPTER_RUNNER): tests/test_ui_render_adapter.c $(SRC_UI_RENDER_ADAPTER) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
...
$(TEST_UI_INTERACTION_RUNNER): tests/test_ui_interaction.c $(SRC_UI_INTERACTION) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_interaction.c $(SRC_UI_INTERACTION) \
		$(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_FLOW_REFERENCE) \
		$(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
		-o $(TEST_UI_INTERACTION_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_MENU_RUNTIME_RUNNER): tests/test_ui_menu_runtime.c $(SRC_UI_MENU_RUNTIME) $(SRC_UI_RENDER_ADAPTER) $(SRC_UI_INTERACTION) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) $(SRC_FLOW_BINDING) $(SRC_FLOW_RUNTIME) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
...
$(TEST_UI_MENU_WORKSPACE_RUNNER): tests/test_ui_menu_workspace.c $(SRC_UI_MENU_WORKSPACE) $(SRC_UI_NESTED_INSPECTOR) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_MAP_CATALOG) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
