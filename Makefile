...
$(TEST_SCENE_FLOW_ADAPTER_RUNNER): tests/test_scene_flow_adapter.c $(SRC_SCENE_FLOW_ADAPTER) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
...
$(TEST_SPRITE_DOCUMENT_RUNNER): tests/test_sprite_document.c $(SRC_SPRITE_DOCUMENT) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_sprite_document.c $(SRC_SPRITE_DOCUMENT) \
		$(SRC_ASSETS) $(SRC_CHECKED_SIZE) -o $(TEST_SPRITE_DOCUMENT_RUNNER) \
		$(TEST_LIBS) $(RPATH)
...
$(TEST_OBJECT_DOCUMENT_RUNNER): tests/test_object_document.c $(SRC_OBJECT_DOCUMENT) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_object_document.c $(SRC_OBJECT_DOCUMENT) \
		$(SRC_ASSETS) $(SRC_CHECKED_SIZE) -o $(TEST_OBJECT_DOCUMENT_RUNNER) \
		$(TEST_LIBS) $(RPATH)

$(TEST_FLOW_DOCUMENT_RUNNER): tests/test_flow_document.c $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_flow_document.c $(SRC_FLOW_DOCUMENT) \
		$(SRC_ASSET_DOCUMENT) -o $(TEST_FLOW_DOCUMENT_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_FLOW_REFERENCE_RUNNER): tests/test_flow_reference.c $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_flow_reference.c $(SRC_FLOW_REFERENCE) \
		$(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) -o $(TEST_FLOW_REFERENCE_RUNNER) \
		$(TEST_LIBS) $(RPATH)

$(TEST_FLOW_RUNTIME_RUNNER): tests/test_flow_runtime.c $(SRC_FLOW_RUNTIME) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
...
$(TEST_FLOW_BINDING_RUNNER): tests/test_flow_binding.c $(SRC_FLOW_BINDING) $(SRC_FLOW_RUNTIME) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_flow_binding.c $(SRC_FLOW_BINDING) \
		$(SRC_FLOW_RUNTIME) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) \
		$(SRC_ASSET_DOCUMENT) -o $(TEST_FLOW_BINDING_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_FLOW_WORKSPACE_RUNNER): tests/test_flow_workspace.c $(SRC_FLOW_WORKSPACE) $(SRC_UI_NESTED_INSPECTOR) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
...
$(TEST_FLOW_PROJECT_CATALOG_RUNNER): tests/test_flow_project_catalog.c $(SRC_FLOW_PROJECT_CATALOG) $(SRC_SCENE_FLOW_ADAPTER) $(SRC_UI_DOCUMENT) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) $(SRC_MAP_CATALOG) $(SRC_ASSET_LOADER) $(SRC_DECAL_IO) $(SRC_OBJECT_DOCUMENT) $(TEST_SCENE_DOCUMENT_SRC) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_flow_project_catalog.c \
		$(SRC_FLOW_PROJECT_CATALOG) $(SRC_SCENE_FLOW_ADAPTER) $(SRC_UI_DOCUMENT) \
		$(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
		$(SRC_MAP_CATALOG) $(SRC_ASSET_LOADER) $(SRC_DECAL_IO) \
		$(SRC_OBJECT_DOCUMENT) $(TEST_SCENE_DOCUMENT_SRC) \
		-o $(TEST_FLOW_PROJECT_CATALOG_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_DOCUMENT_RUNNER): tests/test_ui_document.c $(SRC_UI_DOCUMENT) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_document.c $(SRC_UI_DOCUMENT) \
		$(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
		-o $(TEST_UI_DOCUMENT_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_LAYOUT_RESOLVER_RUNNER): tests/test_ui_layout_resolver.c $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_layout_resolver.c \
		$(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_FLOW_REFERENCE) \
		$(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
		-o $(TEST_UI_LAYOUT_RESOLVER_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_RENDER_ADAPTER_RUNNER): tests/test_ui_render_adapter.c $(SRC_UI_RENDER_ADAPTER) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_render_adapter.c \
		$(SRC_UI_RENDER_ADAPTER) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) \
		$(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) \
		$(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
		-o $(TEST_UI_RENDER_ADAPTER_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_INTERACTION_RUNNER): tests/test_ui_interaction.c $(SRC_UI_INTERACTION) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_interaction.c $(SRC_UI_INTERACTION) \
		$(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_FLOW_REFERENCE) \
		$(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
		-o $(TEST_UI_INTERACTION_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_MENU_RUNTIME_RUNNER): tests/test_ui_menu_runtime.c $(SRC_UI_MENU_RUNTIME) $(SRC_UI_RENDER_ADAPTER) $(SRC_UI_INTERACTION) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) $(SRC_FLOW_BINDING) $(SRC_FLOW_RUNTIME) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_menu_runtime.c $(SRC_UI_MENU_RUNTIME) \
		...
		$(SRC_UI_DOCUMENT) $(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) \
		$(SRC_CHECKED_SIZE) $(SRC_FLOW_BINDING) $(SRC_FLOW_RUNTIME) \
		$(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
		-o $(TEST_UI_MENU_RUNTIME_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_MENU_WORKSPACE_RUNNER): tests/test_ui_menu_workspace.c $(SRC_UI_MENU_WORKSPACE) $(SRC_UI_NESTED_INSPECTOR) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_MAP_CATALOG) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_menu_workspace.c \
		$(SRC_UI_MENU_WORKSPACE) $(SRC_UI_NESTED_INSPECTOR) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_MAP_CATALOG) \
		$(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) \
...
test: $(TEST_DEPS_RUNNER) $(TEST_CORE_RUNNER) $(TEST_DECALS_RUNNER) $(TEST_MENU_STATE_RUNNER) $(TEST_DECAL_IO_RUNNER) $(TEST_DECAL_PAINTER_RUNNER) $(TEST_UI_ELE_RUNNER) $(TEST_SCENE_DOCUMENT_RUNNER) $(TEST_SCENE_FORMAT_RUNNER) $(TEST_COMMAND_SYSTEM_RUNNER) $(TEST_EDITOR_SELECTION_RUNNER) $(TEST_EDITOR_HIGHLIGHT_RUNNER) $(TEST_EDITOR_DOMAIN_RUNNER) $(TEST_UNIFIED_EDITOR_RUNNER) $(TEST_ENTITY_TRIGGER_SESSION_RUNNER) $(TEST_SCENE_FLOW_ADAPTER_RUNNER) $(TEST_INPUT_RUNNER) $(TEST_CAMERA_RUNNER) $(TEST_VERTICAL_PHYSICS_RUNNER) $(TEST_MAP_CATALOG_RUNNER) $(TEST_GLYPH_CACHE_RUNNER) $(TEST_LIGHTING_CACHE_RUNNER) $(TEST_LIGHTING_RUNNER) $(TEST_APP_OPTIONS_RUNNER) $(TEST_SMC_STATE_RUNNER) $(TEST_SMC_INDEXED_RUNNER) $(TEST_BENCHMARK_RUNNER) $(TEST_APP_MODULES_RUNNER) $(TEST_DECAL_PROJECTION_RUNNER) $(TEST_UI_PREFERENCES_RUNNER) $(TEST_UI_COMPOSITOR_RUNNER) $(TEST_MATERIAL_DOCUMENT_RUNNER) $(TEST_DECAL_DOCUMENT_RUNNER) $(TEST_SPRITE_DOCUMENT_RUNNER) $(TEST_SPRITE_ANIMATION_PLAYER_RUNNER) $(TEST_OBJECT_DOCUMENT_RUNNER) $(TEST_FLOW_DOCUMENT_RUNNER) $(TEST_FLOW_REFERENCE_RUNNER) $(TEST_FLOW_RUNTIME_RUNNER) $(TEST_FLOW_BINDING_RUNNER) $(TEST_FLOW_WORKSPACE_RUNNER) $(TEST_FLOW_PROJECT_CATALOG_RUNNER) $(TEST_UI_DOCUMENT_RUNNER) $(TEST_UI_LAYOUT_RESOLVER_RUNNER) $(TEST_UI_RENDER_ADAPTER_RUNNER) $(TEST_UI_INTERACTION_RUNNER) $(TEST_UI_MENU_RUNTIME_RUNNER) $(TEST_UI_MENU_WORKSPACE_RUNNER) $(TEST_ASSET_REFRESH_RUNNER) $(TEST_R9_OPTICAL_SEMANTICS_RUNNER) $(TEST_R9_MULTIHIT_TRACE_RUNNER) $(TEST_R9_OPTICAL_COMPOSITOR_RUNNER) $(TEST_R9_MIRROR_TRACE_RUNNER) $(TEST_OPTICAL_RUNTIME_VIEW_RUNNER) $(TEST_HEIGHTFIELD_SELECTIVE_RUNNER) $(TEST_MIRROR_TRACE_RUNNER) $(TEST_OPTICAL_RENDER_RUNNER) $(TEST_SPRITE_RENDER_RUNNER)
	./$(TEST_DEPS_RUNNER)
	./$(TEST_CORE_RUNNER)
	./$(TEST_DECALS_RUNNER)
