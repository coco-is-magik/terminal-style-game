...
$(TEST_UI_WORKBENCH_CHROME_RUNNER): tests/test_ui_workbench_chrome.c $(SRC_UI_WORKBENCH_CHROME) $(SRC_UI_WORKBENCH_FRAME) $(SRC_UI_WORKBENCH) $(SRC_UI_WORKBENCH_STORE) $(TEST_UI_ELE_SRC) $(SRC_UI_ANIMATION) $(SRC_UI_MOTION) $(SRC_UI_APP_THEME_ADAPTER) $(SRC_UI_CANVAS) $(SRC_MENU_STATE) $(SRC_CONFIG) $(SRC_MAP_CATALOG) $(SRC_UI_PREFERENCES) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_workbench_chrome.c \
		$(SRC_UI_WORKBENCH_CHROME) $(SRC_UI_WORKBENCH_FRAME) $(SRC_UI_WORKBENCH) $(SRC_UI_WORKBENCH_STORE) \
		$(TEST_UI_ELE_SRC) $(SRC_UI_ANIMATION) $(SRC_UI_MOTION) \
		$(SRC_UI_APP_THEME_ADAPTER) \
		$(SRC_UI_CANVAS) $(SRC_MENU_STATE) $(SRC_CONFIG) \
		$(SRC_MAP_CATALOG) \
