...
$(TEST_FLOW_WORKSPACE_RUNNER): tests/test_flow_workspace.c $(SRC_FLOW_WORKSPACE) $(SRC_FLOW_DOCUMENT) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_flow_workspace.c $(SRC_FLOW_WORKSPACE) \
