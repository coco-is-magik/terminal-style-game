...
TEST_UI_ANIMATION_RUNNER     := $(BUILD_DIR)/test-ui-animation
TEST_UI_ANIMATION_PLAYBACK_RUNNER := $(BUILD_DIR)/test-ui-animation-playback
...
TEST_UI_WORKBENCH_GUIDE_RUNNER := $(BUILD_DIR)/test-ui-workbench-guide
...
SRC_UI_ANIMATION := src/ui_animation.c
SRC_UI_ANIMATION_PLAYBACK := src/ui_animation_playback.c
SRC_UI_SCENE_ANIMATION_RENDERER := src/ui_scene_animation_renderer.c
SRC_UI_SYSTEM_ACTION_POLICY := src/ui_system_action_policy.c
...
SRC_UI_WORKBENCH_GUIDE := src/ui_workbench_guide.c
SRC_UI_WORKBENCH_RUNTIME := src/ui_workbench_runtime.c
...
$(TEST_UI_ANIMATION_RUNNER): tests/test_ui_animation.c $(SRC_UI_ANIMATION) $(TEST_UI_ELE_SRC) $(SRC_UI_MOTION) $(SRC_UI_CANVAS) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_animation.c $(SRC_UI_ANIMATION) \
...
$(TEST_UI_ANIMATION_PLAYBACK_RUNNER): tests/test_ui_animation_playback.c $(SRC_UI_ANIMATION_PLAYBACK) $(SRC_UI_THEME) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_animation_playback.c \
		...
		-o $(TEST_UI_ANIMATION_PLAYBACK_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_SYSTEM_ACTION_POLICY_RUNNER): tests/test_ui_system_action_policy.c $(SRC_UI_SYSTEM_ACTION_POLICY) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_system_action_policy.c \
		$(SRC_UI_SYSTEM_ACTION_POLICY) \
		-o $(TEST_UI_SYSTEM_ACTION_POLICY_RUNNER) $(TEST_LIBS) $(RPATH)
...
$(TEST_UI_WORKBENCH_FRAME_RUNNER): tests/test_ui_workbench_frame.c tests/font8x8_test_data.c tests/fixtures/ui_workbench_frame_fixtures.h $(SRC_UI_WORKBENCH_FRAME) $(SRC_UI_WORKBENCH_CHROME) $(SRC_UI_WORKBENCH) $(SRC_UI_WORKBENCH_STORE) $(TEST_UI_ELE_SRC) $(SRC_UI_ANIMATION) $(SRC_UI_MOTION) $(SRC_UI_APP_THEME_ADAPTER) $(SRC_UI_CANVAS) $(SRC_MENU_STATE) $(SRC_CONFIG) $(SRC_MAP_CATALOG) $(SRC_UI_PREFERENCES) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) -Itests/fixtures tests/test_ui_workbench_frame.c tests/font8x8_test_data.c \
...
$(TEST_UI_WORKBENCH_CHROME_RUNNER): tests/test_ui_workbench_chrome.c $(SRC_UI_WORKBENCH_CHROME) $(SRC_UI_WORKBENCH_FRAME) $(SRC_UI_WORKBENCH_GUIDE) $(SRC_UI_WORKBENCH_RUNTIME) $(SRC_UI_WORKBENCH) $(SRC_UI_WORKBENCH_STORE) $(TEST_UI_ELE_SRC) $(SRC_UI_ANIMATION) $(SRC_UI_MOTION) $(SRC_UI_APP_THEME_ADAPTER) $(SRC_UI_CANVAS) $(SRC_MENU_STATE) $(SRC_CONFIG) $(SRC_MAP_CATALOG) $(SRC_UI_PREFERENCES) $(SRC_INPUT) $(SRC_TIMING) $(SRC_RENDERER) $(SRC_UI_COMPOSITOR) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_workbench_chrome.c \
		$(SRC_UI_WORKBENCH_CHROME) $(SRC_UI_WORKBENCH_FRAME) $(SRC_UI_WORKBENCH_GUIDE) $(SRC_UI_WORKBENCH_RUNTIME) $(SRC_UI_WORKBENCH) $(SRC_UI_WORKBENCH_STORE) \
		$(TEST_UI_ELE_SRC) $(SRC_UI_ANIMATION) $(SRC_UI_MOTION) \
		$(SRC_UI_APP_THEME_ADAPTER) \
		$(SRC_UI_CANVAS) $(SRC_MENU_STATE) $(SRC_CONFIG) \
		$(SRC_MAP_CATALOG) \
		$(SRC_UI_PREFERENCES) $(SRC_INPUT) $(SRC_TIMING) $(SRC_RENDERER) $(SRC_UI_COMPOSITOR) \
		-o $(TEST_UI_WORKBENCH_CHROME_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_WORKBENCH_GUIDE_RUNNER): tests/test_ui_workbench_guide.c $(SRC_UI_WORKBENCH_GUIDE) $(SRC_UI_WORKBENCH_FRAME) $(SRC_UI_WORKBENCH_CHROME) $(SRC_UI_WORKBENCH) $(SRC_UI_WORKBENCH_STORE) $(TEST_UI_ELE_SRC) $(SRC_UI_ANIMATION) $(SRC_UI_MOTION) $(SRC_UI_APP_THEME_ADAPTER) $(SRC_UI_CANVAS) $(SRC_MENU_STATE) $(SRC_CONFIG) $(SRC_MAP_CATALOG) $(SRC_UI_PREFERENCES) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_workbench_guide.c \
		$(SRC_UI_WORKBENCH_GUIDE) $(SRC_UI_WORKBENCH_FRAME) $(SRC_UI_WORKBENCH_CHROME) $(SRC_UI_WORKBENCH) $(SRC_UI_WORKBENCH_STORE) \
		$(TEST_UI_ELE_SRC) $(SRC_UI_ANIMATION) $(SRC_UI_MOTION) \
		$(SRC_UI_APP_THEME_ADAPTER) \
		$(SRC_UI_CANVAS) $(SRC_MENU_STATE) $(SRC_CONFIG) \
		$(SRC_MAP_CATALOG) \
...
$(TEST_UI_RENDER_ADAPTER_RUNNER): tests/test_ui_render_adapter.c $(SRC_UI_RENDER_ADAPTER) $(SRC_UI_ANIMATION_PLAYBACK) $(SRC_UI_SCENE_ANIMATION_RENDERER) $(SRC_UI_MOTION) $(SRC_UI_THEME) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_FLOW_DOCUMENT_PLATFORM) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_render_adapter.c \
		$(SRC_UI_RENDER_ADAPTER) $(SRC_UI_ANIMATION_PLAYBACK) \
		$(SRC_UI_SCENE_ANIMATION_RENDERER) $(SRC_UI_MOTION) $(SRC_UI_THEME) \
		$(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) \
...
$(TEST_UI_MENU_WORKSPACE_RUNNER): tests/test_ui_menu_workspace.c $(SRC_UI_MENU_WORKSPACE) $(SRC_UI_EDITOR_ACTION) $(SRC_UI_ANIMATION_PLAYBACK) $(SRC_UI_MOTION) $(SRC_UI_THEME) $(SRC_UI_NESTED_INSPECTOR) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_MAP_CATALOG) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_FLOW_DOCUMENT_PLATFORM) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_menu_workspace.c \
		$(SRC_UI_MENU_WORKSPACE) $(SRC_UI_EDITOR_ACTION) $(SRC_UI_ANIMATION_PLAYBACK) $(SRC_UI_MOTION) $(SRC_UI_THEME) $(SRC_UI_NESTED_INSPECTOR) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_MAP_CATALOG) \
		$(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_FLOW_DOCUMENT_PLATFORM) \
		$(SRC_ASSET_DOCUMENT) \
		-o $(TEST_UI_MENU_WORKSPACE_RUNNER) $(TEST_LIBS) $(RPATH)

$(TEST_UI_EDITOR_PRESENTATION_RUNNER): tests/test_ui_editor_presentation.c $(SRC_UI_EDITOR_PRESENTATION) $(SRC_UI_MENU_WORKSPACE) $(SRC_UI_ANIMATION_PLAYBACK) $(SRC_UI_RENDER_ADAPTER) $(SRC_UI_SCENE_ANIMATION_RENDERER) $(SRC_UI_MOTION) $(SRC_UI_THEME) $(SRC_UI_NESTED_INSPECTOR) $(SRC_UI_LAYOUT_RESOLVER) $(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) $(SRC_CHECKED_SIZE) $(SRC_MAP_CATALOG) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) $(SRC_FLOW_DOCUMENT_PLATFORM) $(SRC_ASSET_DOCUMENT) | dirs
	$(CC) $(CFLAGS) $(INCLUDES) tests/test_ui_editor_presentation.c \
		$(SRC_UI_EDITOR_PRESENTATION) $(SRC_UI_MENU_WORKSPACE) $(SRC_UI_ANIMATION_PLAYBACK) \
		$(SRC_UI_RENDER_ADAPTER) $(SRC_UI_SCENE_ANIMATION_RENDERER) $(SRC_UI_MOTION) \
		$(SRC_UI_THEME) $(SRC_UI_NESTED_INSPECTOR) $(SRC_UI_LAYOUT_RESOLVER) \
		$(SRC_UI_DOCUMENT) $(SRC_RGBA_PARSE) $(SRC_UI_CANVAS) $(SRC_GRID) $(SRC_ASSETS) \
		$(SRC_CHECKED_SIZE) $(SRC_MAP_CATALOG) $(SRC_FLOW_REFERENCE) $(SRC_FLOW_DOCUMENT) \
		$(SRC_FLOW_DOCUMENT_PLATFORM) $(SRC_ASSET_DOCUMENT) \
...
TEST_RUNNERS := $(TEST_DEPS_RUNNER) $(TEST_CORE_RUNNER) $(TEST_DECALS_RUNNER) \
	...
	$(TEST_UI_ANIMATION_PLAYBACK_RUNNER) \
